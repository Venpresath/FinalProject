...
{   
    let home = {
        template: `<div>
        <h1>MUSICBUFF (tbd)</h1>
        <p>Think you know music? Enter an artist to find out. You have blank number of guesses. Break a leg!</p>
        ...
        // empty strings are created here that are filled in when a specific artist. 
