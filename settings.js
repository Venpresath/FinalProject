"use strict";
{
    let settings = {
        ...
        <a href="#!/game"> <button class="difficultyButtonInsane" ng-mouseenter="val4=true" ng-mouseleave="val4=false" ng-click="$ctrl.difficulty(10,1)">Insane <span ng-show="val4"> {{$ctrl.text4}}</span></button></a>
        </div>
