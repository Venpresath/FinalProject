"use strict";
{
    let settings = {
        ...
        <a href="#!/game"><button class="difficultyButton" ng-mouseenter="val=true" ng-mouseleave="val=false" ng-click="$ctrl.difficulty(3,3)">Easy<span ng-show="val">3 Wins 3 Losses</span></button><a>        
