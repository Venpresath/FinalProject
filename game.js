"use strict";
{
    let game = {
        ...
        <input type = "text" placeholder="Guess the song" ng-model="$ctrl.guess"><button ng-click="$ctrl.getSongName($ctrl.songNum); $ctrl.getTrackId($ctrl.songNum); $ctrl.clearInput()">GEET'EM</button>
